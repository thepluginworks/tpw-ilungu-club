...
if ( ! function_exists( 'tpw_core_payments_render_frontend_method_detail' ) ) {
    function tpw_core_payments_render_frontend_method_detail( $method_slug ) {
		...
		$admin_url       = function_exists( 'tpw_core_build_payment_method_admin_url' ) ? tpw_core_build_payment_method_admin_url( $method_slug ) : admin_url( 'admin.php?page=ilungu-club-settings&tab=payment-methods' );
