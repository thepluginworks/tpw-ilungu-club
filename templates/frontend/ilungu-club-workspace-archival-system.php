...
?>
<section id="ilungu-club-archival-system-overview" class="ilungu-club-dashboard__hero tpw-flexiclub-dashboard__hero tpw-card ilungu-club-control-workspace__hero tpw-flexiclub-control-workspace__hero">
...
<section id="ilungu-club-archival-system-legacy" class="ilungu-club-dashboard__section tpw-flexiclub-dashboard__section tpw-card ilungu-club-control-workspace__notice-card tpw-flexiclub-control-workspace__notice-card">
...
<section id="ilungu-club-archival-system-tool" class="ilungu-club-dashboard__section tpw-flexiclub-dashboard__section tpw-card ilungu-club-control-workspace__section tpw-flexiclub-control-workspace__section">
	...
	<div class="ilungu-club-control-workspace__embed tpw-flexiclub-control-workspace__embed">
		<?php iLungu_Club_Admin_Menu::render_frontend_tpw_control_section( $workspace['section_key'] ?? 'upload-pages' ); ?>
	</div>
</section>
