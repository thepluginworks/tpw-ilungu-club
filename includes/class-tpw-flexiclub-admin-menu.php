	...
	protected static function get_dashboard_extend_cards( $prefer_frontend = false ) {
		$definitions = [
			...
			[
				...
				'plugin_names' => [ 'iLungu Subscriptions', 'TPW FlexiSubscriptions' ],
				'text_domains' => [ 'ilungusubscriptions', 'tpw-flexisubscriptions' ],
				'basenames'    => [ 'ilungusubscriptions/ilungusubscriptions.php', 'tpw-flexisubscriptions/flexisubscriptions.php', 'tpw-flexisubscriptions/tpw-flexisubscriptions.php' ],
			...
			[
				...
				'plugin_names' => [ 'iLungu Rota', 'TPW FlexiRota' ],
				'text_domains' => [ 'ilungurota', 'tpw-flexirota' ],
				'basenames'    => [ 'ilungurota/ilungurota.php', 'tpw-flexirota/flexirota.php', 'tpw-flexirota/tpw-flexirota.php' ],
			...
			[
				...
				'plugin_names' => [ 'iLungu Lodge', 'TPW RSVP Lodge Meetings', 'RSVP Lodge Meetings' ],
